...
// static final String DRONE_PAYLOAD_ID =
...
// static final String ASSIGNMENT_TEST_DRONE_ID =
...
// jdbcTemplate.update("""
// INSERT INTO category_services (id, name, description, created_at, updated_at,
// version)
// VALUES (?, 'Giám sát môi trường', 'Forest monitoring demo service for OMSS
// mission control.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)
...
// jdbcTemplate.update("""
// INSERT INTO preferred_times (id, code, name, start_time, end_time,
// created_at, updated_at, version)
// VALUES (?, 'MORNING', 'Morning', '07:00:00', '11:00:00', CURRENT_TIMESTAMP,
// CURRENT_TIMESTAMP, 0)
...
// created_at, updated_at, version
// )
// VALUES (?, 'X500-SITL', 'PX4', 'Simulation', 45, 2.5, 120, 12, 'SIM', '{}',
...
// created_at, updated_at, version
// )
// VALUES (?, 'Front RGB + Thermal', 'RGB_THERMAL', 0.45, 'FPV, thermal hotspot,
// LiDAR preview', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)
// ON CONFLICT (id) DO UPDATE SET
...
// jdbcTemplate.update("""
// INSERT INTO orders (
// id, user_id, title, service_id, description, address, point,
// preferred_date, preferred_date_from, preferred_date_to, preferred_time_id,
// order_status, created_at, updated_at, version
// )
// VALUES (
// ?, CAST(? AS uuid), 'Forest Fire Monitoring - Compact Map',
// ?, 'Inspect the forest fire zone and capture thermal evidence for response
// planning.',
// 'Forest Monitoring Compact Simulation Area',
// ST_SetSRID(ST_MakePoint(-122.378, 37.7983), 4326),
// ?, ?, ?, (SELECT id FROM preferred_times WHERE code = 'MORNING'),
// 'IN_PROGRESS',
// CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0
// )
// ON CONFLICT (id) DO UPDATE SET
...
// Date.valueOf("2026-09-19"), Date.valueOf("2026-09-19"));
// }
...
// ?, 'Assign this mission to a simulation drone and operator, then accept it to
// generate a fresh A* energy-aware plan.',
...
// order_status = EXCLUDED.order_status,
// updated_at = CURRENT_TIMESTAMP
// """, ASSIGNMENT_TEST_ORDER_ID, CUSTOMER_ID, SERVICE_ID,
// Date.valueOf("2026-09-21"), Date.valueOf("2026-09-21"),
...
// updated_at = CURRENT_TIMESTAMP
// """, ASSIGNMENT_TEST_MISSION_ID, ASSIGNMENT_TEST_MISSION_ID,
// ASSIGNMENT_TEST_ORDER_ID);
...
// jdbcTemplate.update("DELETE FROM mission_plans WHERE mission_id = ?",
// ASSIGNMENT_TEST_MISSION_ID);
// jdbcTemplate.update("DELETE FROM mission_operator_assignments WHERE
// mission_id = ?", ASSIGNMENT_TEST_MISSION_ID);
// jdbcTemplate.update("DELETE FROM mission_drone_assignments WHERE mission_id =
// ?", ASSIGNMENT_TEST_MISSION_ID);
// }
...
// 'Fly the compact forest map route, scan the fire area, and verify thermal
// hotspots.',
...
// )
// VALUES ('MDA-2024-0891-A', ?, (SELECT id FROM drones WHERE drone_code =
// 'DRN-0047'), 'SYSTEM_SEED', 'DEMO_SEED', 'ACTIVE',
...
// available_battery_percent_at_planning =
// EXCLUDED.available_battery_percent_at_planning,
